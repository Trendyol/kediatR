  ...
  ShouldSpec({
    ...
    context("Registry Performance Comparison") {
      ...
      should("demonstrate significant performance improvement for notification handler resolution") {
        ...
        repeat(100) {
          uncachedRegistry.resolveNotificationHandlers(NotificationForMultipleHandlers::class)
          cachedRegistry.resolveNotificationHandlers(NotificationForMultipleHandlers::class)
        }
        ...
        val uncachedTime = measureTimeMillis {
          repeat(iterations) {
            uncachedRegistry.resolveNotificationHandlers(NotificationForMultipleHandlers::class)
            uncachedRegistry.resolveNotificationHandlers(PingForInherited::class)
            uncachedRegistry.resolveNotificationHandlers(ExtendedPing::class)
            uncachedRegistry.resolveNotificationHandlers(Ping::class)
          }
        }
        ...
        val cachedTime = measureTimeMillis {
          repeat(iterations) {
            cachedRegistry.resolveNotificationHandlers(NotificationForMultipleHandlers::class)
            cachedRegistry.resolveNotificationHandlers(PingForInherited::class)
            cachedRegistry.resolveNotificationHandlers(ExtendedPing::class)
            cachedRegistry.resolveNotificationHandlers(Ping::class)
          }
        }
      ...
      should("verify cache statistics accuracy") {
        ...
        cachedRegistry.resolveHandler(TestCommandForInheritance::class)
        cachedRegistry.resolveNotificationHandlers(NotificationForMultipleHandlers::class)
        cachedRegistry.getPipelineBehaviors()
